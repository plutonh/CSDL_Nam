...
#define AUTOTB_TVIN_AB "../tv/cdatafile/c.mm.autotvin_AB.dat"
#define AUTOTB_TVOUT_AB "../tv/cdatafile/c.mm.autotvout_AB.dat"
#define AUTOTB_TVIN_AB_port "../tv/cdatafile/c.mm.autotvin_AB_port.dat"
#define AUTOTB_TVOUT_AB_port "../tv/cdatafile/c.mm.autotvout_AB_port.dat"
#define AUTOTB_TVIN_A_port "../tv/cdatafile/c.mm.autotvin_A_port.dat"
#define AUTOTB_TVOUT_A_port "../tv/cdatafile/c.mm.autotvout_A_port.dat"
#define AUTOTB_TVIN_B_port "../tv/cdatafile/c.mm.autotvin_B_port.dat"
#define AUTOTB_TVOUT_B_port "../tv/cdatafile/c.mm.autotvout_B_port.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_AB_port "../tv/rtldatafile/rtl.mm.autotvout_AB_port.dat"
#define AUTOTB_TVOUT_PC_A_port "../tv/rtldatafile/rtl.mm.autotvout_A_port.dat"
#define AUTOTB_TVOUT_PC_B_port "../tv/rtldatafile/rtl.mm.autotvout_B_port.dat"
...
extern "C"
void mm_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_mm_hw(void* __xlx_apatb_param_A, void* __xlx_apatb_param_B, void* __xlx_apatb_param_AB)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_AB_port),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_AB_port),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_AB_port),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_AB_port),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_AB_port),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_AB_port),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_AB };
  port3.depth = { 64 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port4 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_A_port),
#else
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port5 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_B_port),
#else
  ...
  try {
    ...
    mm_hw_stub_wrapper(__xlx_apatb_param_A, __xlx_apatb_param_B, __xlx_apatb_param_AB);
