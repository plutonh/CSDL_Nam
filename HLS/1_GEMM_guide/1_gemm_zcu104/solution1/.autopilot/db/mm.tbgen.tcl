...
set Spec2ImplPortList { 
	A { ap_memory {  { A_address0 mem_address 1 6 }  { A_ce0 mem_ce 1 1 }  { A_q0 in_data 0 32 }  { A_address1 MemPortADDR2 1 6 }  { A_ce1 MemPortCE2 1 1 }  { A_q1 in_data 0 32 } } }
	B { ap_memory {  { B_address0 mem_address 1 6 }  { B_ce0 mem_ce 1 1 }  { B_q0 in_data 0 32 }  { B_address1 MemPortADDR2 1 6 }  { B_ce1 MemPortCE2 1 1 }  { B_q1 in_data 0 32 } } }
