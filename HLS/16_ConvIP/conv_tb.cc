...
int main(void) {
	...
	float *input = (float *) malloc(sizeof(float) * 5000000);
	float *weight = (float *) malloc(sizeof(float) * 5000000);
	float *scale = (float *) malloc(sizeof(float) * 1000);
	float *shift = (float *) malloc(sizeof(float) * 1000);
	float *output = (float *) malloc(sizeof(float) * 5000000);
