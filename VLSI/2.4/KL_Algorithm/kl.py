...
# class Edge:
#     def _init_(self, left_id, right_id):
...
#             if edge.left_v.partition_label != edge.right.partition_label:
#                 cost += 1
...
#                 if self.graph.vertices[i].partion_label == "A":
...
#         if left_id not in seen_vertice_ids:
#             vertices.append(Vertex(left_id))
#             seen_vertice_ids.append(left_id)
        
#         if right_id not in seen_vertice_ids:
#             vertices.append(Vertex(right_id))
#             seen_vertice_ids.append(right_id)
